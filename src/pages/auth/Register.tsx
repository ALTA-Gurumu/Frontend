import { LayoutRegisLogin } from "../../components/Layout";
...
const Register = () => {
  return (
    <>
      ...
      <LayoutRegisLogin>
        <div className="w-full lg:min-h-screen flex justify-center items-center mt-10">
          <div className=" w-10/12 mt-5 lg:mt-0 lg:w-8/12 h-full lg:h-6/6 bg-white rounded-3xl border-2">
